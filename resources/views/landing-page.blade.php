...
<body class="bg-white text-gray-800">
    ...
    <section id="home" class="min-h-[calc(100vh-4rem)] flex flex-col justify-center items-center text-center px-6 hero-bg">
        <div class="hero-content text-white">
            ...
            <p class="text-lg sm:text-xl font-medium text-white/90 fade-in" style="transition-delay:0.3s">Temukan Kisahmu di Cafe <strong>The Legend Cafe & Resto</strong> Tasikmalaya</p>
    ...
    <section id="menu" class="py-16 sm:py-20 px-4 sm:px-6 bg-white">
        <h2 class="text-3xl md:text-4xl font-bold text-center mb-4 fade-in text-coffee">
            Menu Favorit The Legend Cafe & Resto
        </h2>
        <p class="text-center text-gray-600 mb-10 fade-in max-w-2xl mx-auto">
            Pilihan menu unggulan yang paling sering dipesan oleh pelanggan kami.
        </p>
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <!-- FOOD -->
            <div class="p-8 border rounded-2xl shadow-sm fade-in hover:shadow-lg transition bg-gradient-to-br from-white to-creamy/60">
                <i class="fas fa-utensils text-4xl text-coffee mb-4"></i>
                <h3 class="text-2xl font-semibold mb-3 text-coffee">Food</h3>
                <p class="text-gray-600 mb-4">Menu makanan favorit pengunjung</p>

                <ul class="text-gray-700 text-sm space-y-2 mb-6">
                    <li>✔ Yamin Manis & Asin</li>
                    <li>✔ Nasi Goreng Spesial</li>
                    <li>✔ Chicken Katsu & Steak</li>
                    <li>✔ Capcay & Aneka Mie</li>
                </ul>

                <a href="/menu"
                class="inline-block px-6 py-2 bg-coffee text-white rounded-full text-sm font-semibold hover:bg-accent transition">
                    Lihat Menu Food →
                </a>
            </div>

            <!-- BEVERAGE -->
            <div class="p-8 border rounded-2xl shadow-sm fade-in hover:shadow-lg transition bg-gradient-to-br from-white to-accent/10">
                <i class="fas fa-mug-hot text-4xl text-coffee mb-4"></i>
                <h3 class="text-2xl font-semibold mb-3 text-coffee">Beverage</h3>
                <p class="text-gray-600 mb-4">Minuman kopi & non-kopi terbaik</p>

                <ul class="text-gray-700 text-sm space-y-2 mb-6">
                    <li>✔ Coffee (Espresso, Latte, Cappuccino)</li>
                    <li>✔ Non Coffee & Tea</li>
                    <li>✔ Indomie Series</li>
                </ul>
        ...
        <div class="text-center mt-14 fade-in">
            <a href="/menu"
            class="px-10 py-4 bg-accent text-coffee rounded-full text-base sm:text-lg shadow-xl font-bold hover:bg-accent/80 transition">
